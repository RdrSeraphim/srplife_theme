      ...
      <head>
        ...
        <style>
          ...
          html {
            ...
            /* Recreated purple crosshatch background */
            background-color: rgba(87, 76, 143, 1);
            background-image:
              repeating-linear-gradient(
                45deg,
                transparent,
                transparent 4px,
                rgba(117, 105, 176, 1) 4px,
                rgba(117, 105, 176, 1) 5px
              ),
              repeating-linear-gradient(
                -45deg,
                transparent,
                transparent 4px,
                rgba(147, 138, 193, 1) 4px,
                rgba(147, 138, 193, 1) 5px
              );
          }
        ...
        <div class="container">
          <div class="cde-window">
            ...
            <div class="cde-title-bar">
              ...
              <div class="cde-title-text">~/rss</div>
